...
# Khám phá dữ liệu nhạy cảm có trong S3 bucket bằng Amazon Macie
...
3. [Tạo Custom data identifiers](3-macie/)
4. [Tạo Macie job](4-createjob/)
5. [Macie job run và findings](5-monitoring/)
